...
contract Halo2Verifier {
    ...
    uint256 internal constant CHALLENGE_MPTR = 0x07c0;

    uint256 internal constant THETA_MPTR = 0x07c0;
    uint256 internal constant  BETA_MPTR = 0x07e0;
    uint256 internal constant GAMMA_MPTR = 0x0800;
    uint256 internal constant     Y_MPTR = 0x0820;
    uint256 internal constant     X_MPTR = 0x0840;
    uint256 internal constant  ZETA_MPTR = 0x0860;
    uint256 internal constant    NU_MPTR = 0x0880;
    uint256 internal constant    MU_MPTR = 0x08a0;

    uint256 internal constant       ACC_LHS_X_MPTR = 0x08c0;
    uint256 internal constant       ACC_LHS_Y_MPTR = 0x08e0;
    uint256 internal constant       ACC_RHS_X_MPTR = 0x0900;
    uint256 internal constant       ACC_RHS_Y_MPTR = 0x0920;
    uint256 internal constant             X_N_MPTR = 0x0940;
    uint256 internal constant X_N_MINUS_1_INV_MPTR = 0x0960;
    uint256 internal constant          L_LAST_MPTR = 0x0980;
    uint256 internal constant         L_BLIND_MPTR = 0x09a0;
    uint256 internal constant             L_0_MPTR = 0x09c0;
    uint256 internal constant   INSTANCE_EVAL_MPTR = 0x09e0;
    uint256 internal constant   QUOTIENT_EVAL_MPTR = 0x0a00;
    uint256 internal constant      QUOTIENT_X_MPTR = 0x0a20;
    uint256 internal constant      QUOTIENT_Y_MPTR = 0x0a40;
    uint256 internal constant       G1_SCALAR_MPTR = 0x0a60;
    uint256 internal constant   PAIRING_LHS_X_MPTR = 0x0a80;
    uint256 internal constant   PAIRING_LHS_Y_MPTR = 0x0aa0;
    uint256 internal constant   PAIRING_RHS_X_MPTR = 0x0ac0;
    uint256 internal constant   PAIRING_RHS_Y_MPTR = 0x0ae0;
    ...
    function verifyProof(
        ...
        assembly {
...

            {
                ...
                extcodecopy(vk, VK_MPTR, 0x00, 0x04a0)
